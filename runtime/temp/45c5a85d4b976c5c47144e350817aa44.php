<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"/www/wwwroot/punalei/addons/ldcms/site_info.html";i:1754571368;s:63:"/www/wwwroot/punalei/application/admin/view/layout/default.html";i:1754571368;s:60:"/www/wwwroot/punalei/application/admin/view/common/meta.html";i:1754571368;s:62:"/www/wwwroot/punalei/application/admin/view/common/script.html";i:1754571368;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="panel panel-default panel-intro">
    <div class="panel-heading">
        ...
        <ul class="nav nav-tabs">
            ...
            <?php endforeach; if($auth->check('ldcms/site_info/add')): ?>
    ...
    <div class="panel-body">
        <div id="myTabContent" class="tab-content">
            <!--@formatter:off-->
            <?php if(!(empty($siteList) || (($siteList instanceof \think\Collection || $siteList instanceof \think\Paginator ) && $siteList->isEmpty()))): foreach($siteList as $index=>$vo): ?>
            <div class="tab-pane fade <?php echo !empty($vo['active'])?'active in' : ''; ?>" id="tab-<?php echo $vo['name']; ?>">
                <div class="widget-body no-padding">
                    <form id="<?php echo $vo['name']; ?>-form" class="edit-form form-horizontal" role="form" data-toggle="validator"
                        method="POST" action="<?php echo url('ldcms/site_info/index'); ?>">
                        <?php echo token(); ?>
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="12%"><?php echo __('Name'); ?></th>
                                    <th width='8%'>删除</th>
                                    <th width="2%"></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr data-favisible="<?php echo htmlentities((isset($item['visible']) && ($item['visible'] !== '')?$item['visible']:'') ?? ''); ?>" data-name="<?php echo $item['name']; ?>"
                                    class="<?php if($item['visible']??''): ?>hidden<?php endif; ?>">
                                    <td><?php echo $item['title']; ?></td>
                                    <td>
                                        <div class="row">
                                            <div class="col-sm-8 col-xs-12">
                                                <?php switch($item['type']): case "string": ?>
                                                <input <?php echo $item['extend_html']; ?> type="text" name="row[<?php echo $item['name']; ?>]"
                                                    value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control"
                                                    data-rule="<?php echo $item['rule']; ?>" />
                                                <?php break; case "password": ?>
                                                <input <?php echo $item['extend_html']; ?> type="password" name="row[<?php echo $item['name']; ?>]"
                                                    value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control"
                                                    data-rule="<?php echo $item['rule']; ?>" />
                                                <?php break; case "text": ?>
                                                <textarea <?php echo $item['extend_html']; ?> name="row[<?php echo $item['name']; ?>]"
                                                    class="form-control" data-rule="<?php echo $item['rule']; ?>" rows="5"
                                                    data-tip="<?php echo $item['tip']; ?>"><?php echo htmlentities($item['value'] ?? ''); ?></textarea>
                                                <?php break; case "editor": ?>
                                                <textarea <?php echo $item['extend_html']; ?> name="row[<?php echo $item['name']; ?>]"
                                                    id="editor-<?php echo $item['name']; ?>" class="form-control editor"
                                                ...
                                                <dl <?php echo $item['extend_html']; ?> class="fieldlist" data-name="row[<?php echo $item['name']; ?>]">
                                                    ...
                                                    <dd><a href="javascript:;" class="append btn btn-sm btn-success"><i
                                                                class="fa fa-plus"></i> <?php echo __('Append'); ?></a></dd>
                                                    <textarea name="row[<?php echo $item['name']; ?>]" class="form-control hide"
                                                        cols="30"
                                                        rows="5"><?php echo htmlentities(json_encode($arrList,JSON_UNESCAPED_UNICODE) ?? ''); ?></textarea>
                                                </dl>

                                                <?php break; case "date": ?>
                                                <input <?php echo $item['extend_html']; ?> type="text" name="row[<?php echo $item['name']; ?>]"
                                                    value="<?php echo htmlentities($item['value'] ?? ''); ?>"
                                                ...
                                                <input <?php echo $item['extend_html']; ?> type="text" name="row[<?php echo $item['name']; ?>]"
                                                    ...
                                                    data-date-format="YYYY-MM-DD HH:mm:ss" data-tip="<?php echo $item['tip']; ?>"
                                                    data-rule="<?php echo $item['rule']; ?>" />
                                                <?php break; case "datetimerange": ?>
                                                <input <?php echo $item['extend_html']; ?> type="text" name="row[<?php echo $item['name']; ?>]"
                                                    value="<?php echo htmlentities($item['value'] ?? ''); ?>"
                                                    class="form-control datetimerange" data-tip="<?php echo $item['tip']; ?>"
                                                    data-rule="<?php echo $item['rule']; ?>" />
                                                <?php break; case "number": ?>
                                                <input <?php echo $item['extend_html']; ?> type="number" name="row[<?php echo $item['name']; ?>]"
                                                    value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control"
                                                    data-rule="<?php echo $item['rule']; ?>" />
                                                ...
                                                <div class="checkbox">
                                                    ...
                                                    <label for="row[<?php echo $item['name']; ?>][]-<?php echo $key; ?>"><input
                                                            id="row[<?php echo $item['name']; ?>][]-<?php echo $key; ?>" name="row[<?php echo $item['name']; ?>][]"
                                                            type="checkbox" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($item['value'])?$item['value']:explode(',',$item['value']))): ?>checked<?php endif; ?> />
                                                        <?php echo $vo; ?></label>
                                                ...
                                                <div class="radio">
                                                    ...
                                                    <label for="row[<?php echo $item['name']; ?>]-<?php echo $key; ?>"><input
                                                            id="row[<?php echo $item['name']; ?>]-<?php echo $key; ?>" name="row[<?php echo $item['name']; ?>]"
                                                            type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($item['value'])?$item['value']:explode(',',$item['value']))): ?>checked<?php endif; ?> />
                                                        <?php echo $vo; ?></label>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </div>
                                                <?php break; case "select": case "selects": ?>
                                                <select <?php echo $item['extend_html']; ?>
                                                    name="row[<?php echo $item['name']; ?>]<?php echo $item['type']=='selects'?'[]':''; ?>"
                                                    class="form-control selectpicker" data-tip="<?php echo $item['tip']; ?>"
                                                    <?php echo $item['type']=='selects'?'multiple':''; ?>>
                                                    <?php if(is_array($item['content']) || $item['content'] instanceof \think\Collection || $item['content'] instanceof \think\Paginator): if( count($item['content'])==0 ) : echo "" ;else: foreach($item['content'] as $key=>$vo): ?>
                                                ...
                                                <div class="form-inline">
                                                    <input id="c-<?php echo $item['name']; ?>" class="form-control" size="50"
                                                        name="row[<?php echo $item['name']; ?>]" type="text"
                                                        value="<?php echo htmlentities($item['value'] ?? ''); ?>" data-tip="<?php echo $item['tip']; ?>">
                                                    <span><button type="button" id="faupload-<?php echo $item['name']; ?>"
                                                            class="btn btn-danger faupload"
                                                            data-input-id="c-<?php echo $item['name']; ?>"
                                                            data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp,image/webp"
                                                            data-multiple="<?php echo $item['type']=='image'?'false':'true'; ?>"
                                                            data-preview-id="p-<?php echo $item['name']; ?>"><i
                                                                class="fa fa-upload"></i>
                                                            <?php echo __('Upload'); ?></button></span>
                                                    <span><button type="button" id="fachoose-<?php echo $item['name']; ?>"
                                                            class="btn btn-primary fachoose"
                                                            data-input-id="c-<?php echo $item['name']; ?>" data-mimetype="image/*"
                                                            data-multiple="<?php echo $item['type']=='image'?'false':'true'; ?>"><i
                                                                class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                                                    <span class="msg-box n-right" for="c-<?php echo $item['name']; ?>"></span>
                                                    <ul class="row list-inline faupload-preview" id="p-<?php echo $item['name']; ?>">
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="form-inline">
                                                    ...
                                                    <span><button type="button" id="faupload-<?php echo $item['name']; ?>"
                                                            class="btn btn-danger faupload"
                                                            data-input-id="c-<?php echo $item['name']; ?>"
                                                            data-multiple="<?php echo $item['type']=='file'?'false':'true'; ?>"><i
                                                                class="fa fa-upload"></i>
                                                            <?php echo __('Upload'); ?></button></span>
                                                    <span><button type="button" id="fachoose-<?php echo $item['name']; ?>"
                                                            class="btn btn-primary fachoose"
                                                ...
                                                <input id="c-<?php echo $item['name']; ?>" name="row[<?php echo $item['name']; ?>]" type="hidden"
                                                    value="<?php echo $item['value']?1:0; ?>">
                                                <a href="javascript:;" data-toggle="switcher" class="btn-switcher"
                                                    data-input-id="c-<?php echo $item['name']; ?>" data-yes="1" data-no="0">
                                                    <i
                                                        class="fa fa-toggle-on text-success <?php if(!$item['value']): ?>fa-flip-horizontal text-gray<?php endif; ?> fa-2x"></i>
                                                </a>
                                                <?php break; case "bool": ?>
                                                <label for="row[<?php echo $item['name']; ?>]-yes"><input id="row[<?php echo $item['name']; ?>]-yes"
                                                        name="row[<?php echo $item['name']; ?>]" type="radio" value="1"
                                                        <?php echo !empty($item['value'])?'checked':''; ?> />
                                                    <?php echo __('Yes'); ?></label>
                                                <label for="row[<?php echo $item['name']; ?>]-no"><input id="row[<?php echo $item['name']; ?>]-no"
                                                        name="row[<?php echo $item['name']; ?>]" type="radio" value="0"
                                                        <?php echo !empty($item['value'])?'':'checked'; ?> />
                                                    <?php echo __('No'); ?></label>
                                                <?php break; case "city": ?>
                                                <div style="position:relative">
                                                    <input <?php echo $item['extend_html']; ?> type="text" name="row[<?php echo $item['name']; ?>]"
                                                        id="c-<?php echo $item['name']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>"
                                                        class="form-control" data-toggle="city-picker"
                                                        data-rule="<?php echo $item['rule']; ?>" />
                                                </div>
                                                <?php break; case "selectpage": case "selectpages": break; case "custom": ?>
                                                <?php echo $item['extend_html']; break; endswitch; if($item['tip']): ?>
                                                <p style="color: #777;margin-top: 3px"><?php echo $item['tip']; ?></p>
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <td>{$ld.<?php echo $item['name']; ?>}</td>
                                    <td>
                                        <?php if(!in_array($item['name'],$noDel)): if($auth->check('ldcms/site_info/delcfg')): ?>
                                        <a href="javascript:;" class="btn btn-xs btn-danger btn-delcfg"
                                            data-toggle="tooltip" data-original-title="删除" data-name="<?php echo $item['name']; ?>"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="layer-footer">
                                            <button type="submit"
                                                class="btn btn-primary btn-embossed disabled"><?php echo __('OK'); ?></button>
                                            <button type="reset"
                                                class="btn btn-default btn-embossed"><?php echo __('Reset'); ?></button>
                                        </div>
                                    </td>
            ...
            <div class="tab-pane fade" id="addcfg">
                <form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST"
                    action="<?php echo url('ldcms/site_info/add'); ?>">
                    <?php echo token(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <input type="text" name="row[group]" id="c-group" class="form-control selectpage"
                                data-source="<?php echo url('ldcms/site_info/getGroups'); ?>" data-field="title" data-pagination="true"
...
value2|title2</textarea>
                    ...
                    <div class="form-group">
                        <label for="visible" class="control-label col-xs-12 col-sm-2">
                            <?php echo __('Visible condition'); ?>:</label>
                        <div class="col-xs-12 col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <textarea name="row[extend]" id="extend" cols="30" rows="5" class="form-control"
                                data-tip="<?php echo __('Extend tips'); ?>" data-msg-extend="当类型为自定义时，扩展属性不能为空"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
