<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:106:"/www/wwwroot/punalei/public/../application/admin/view/../../../addons/ldcms/utils/builder/view/fields.html";i:1754571368;s:63:"/www/wwwroot/punalei/application/admin/view/layout/default.html";i:1754571368;s:60:"/www/wwwroot/punalei/application/admin/view/common/meta.html";i:1754571368;s:62:"/www/wwwroot/punalei/application/admin/view/common/script.html";i:1754571368;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div data-type="<?php echo $item['item_group']; ?>" class="form-group item-group-tabs <?php echo (isset($item['class']) && ($item['class'] !== '')?$item['class']:''); ?>" <?php if(!(empty($item['visible']) || (($item['visible'] instanceof \think\Collection || $item['visible'] instanceof \think\Paginator ) && $item['visible']->isEmpty()))): ?> data-favisible="<?php echo $item['visible']; ?>" <?php endif; ?>>
    ...
    <div class="col-xs-12 col-sm-8">
        ...
        <input <?php echo $item['extend_html']; ?> type="text" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>" placeholder="<?php echo (isset($item['placeholder']) && ($item['placeholder'] !== '')?$item['placeholder']:''); ?>" class="form-control" data-rule="<?php echo $item['rule']; ?>" data-tip="<?php echo $item['tip']; ?>" />
        <?php break; case "password": ?>
        <input <?php echo $item['extend_html']; ?> type="password" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>" placeholder="<?php echo (isset($item['placeholder']) && ($item['placeholder'] !== '')?$item['placeholder']:''); ?>" class="form-control" data-rule="<?php echo $item['rule']; ?>" data-tip="<?php echo $item['tip']; ?>" />
        <?php break; case "text": case "editor": ?>
        <textarea <?php echo $item['extend_html']; ?> name="<?php echo $item['field_name']; ?>" placeholder="<?php echo (isset($item['placeholder']) && ($item['placeholder'] !== '')?$item['placeholder']:''); ?>" id="c-<?php echo $item['item_id']; ?>"
        ...
        <?php break; case "array": if($item['field']=='downloadurl'): $item['value']=isset($values[$item['field']])?$item['value']:$item['download_list']; ?>
            <dl <?php echo $item['extend_html']; ?> class="fieldlist downloadlist" data-name="<?php echo $item['field_name']; ?>" data-template="downloadurltpl">
                <dd>
                ...
                <textarea name="<?php echo $item['field_name']; ?>" class="form-control hide" cols="30" rows="5"><?php echo htmlentities($item['value'] ?? ''); ?></textarea>
            </dl>
        <?php else: $arrList=empty($item['value']) ? '' : json_decode($item['value'],true); ?>
            <dl <?php echo $item['extend_html']; ?> class="fieldlist" data-name="<?php echo $item['field_name']; ?>">
                <dd>
                ...
                <textarea name="<?php echo $item['field_name']; ?>" class="form-control hide" cols="30" rows="5"><?php if(!empty($arrList)): ?><?php echo htmlentities(json_encode($arrList,JSON_UNESCAPED_UNICODE) ?? ''); endif; ?></textarea>
            </dl>
        <?php endif; break; case "date": ?>
        <input <?php echo $item['extend_html']; ?> type="text" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>" />
        <?php break; case "time": ?>
        <input <?php echo $item['extend_html']; ?> type="text" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control datetimepicker" data-date-format="HH:mm:ss" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>" />
        <?php break; case "datetime": ?>
        <input <?php echo $item['extend_html']; ?> type="text" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>" />
        <?php break; case "datetimerange": ?>
        <input <?php echo $item['extend_html']; ?> type="text" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control datetimerange" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>"/>
        <?php break; case "number": ?>
        <input <?php echo $item['extend_html']; ?> type="number" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>"
        ...
        <?php break; case "checkbox": $content_list=isset($item['content_list_arr'])? $item['content_list_arr']:$item['content_list']; if(is_array($content_list) || $content_list instanceof \think\Collection || $content_list instanceof \think\Paginator): if( count($content_list)==0 ) : echo "" ;else: foreach($content_list as $key=>$vo): ?>
            <div class="checkbox checkbox-inline">
                <label for="<?php echo $item['field_name']; ?>[]-<?php echo $key; ?>"><input id="<?php echo $item['field_name']; ?>[]-<?php echo $key; ?>" name="<?php echo $item['field_name']; ?>[]" type="checkbox" value="<?php echo $key; ?>" data-rule="<?php echo $item['rule']; ?>" data-tip="<?php echo $item['tip']; ?>" <?php if(in_array(($key), is_array($item['value'])?$item['value']:explode(',',$item['value']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <span class="msg-box n-right" for="c-<?php echo $item['item_id']; ?>"></span>
        <?php break; case "radio": $content_list=isset($item['content_list_arr'])? $item['content_list_arr']:$item['content_list']; if(is_array($content_list) || $content_list instanceof \think\Collection || $content_list instanceof \think\Paginator): if( count($content_list)==0 ) : echo "" ;else: foreach($content_list as $key=>$vo): ?>
            <div class="radio radio-inline">
                <label for="<?php echo $item['field_name']; ?>-<?php echo $key; ?>"><input id="<?php echo $item['field_name']; ?>-<?php echo $key; ?>" name="<?php echo $item['field_name']; ?>" type="radio" value="<?php echo $key; ?>" data-rule="<?php echo $item['rule']; ?>" data-tip="<?php echo $item['tip']; ?>" <?php if(in_array(($key), is_array($item['value'])?$item['value']:explode(',',$item['value']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <span class="msg-box n-right" for="c-<?php echo $item['item_id']; ?>"></span>
        <?php break; case "select": case "selects": $content_list=isset($item['content_list_arr'])? $item['content_list_arr']:$item['content_list']; ?>
        <select <?php echo $item['extend_html']; ?> id="c-<?php echo $item['item_id']; ?>" name="<?php echo $item['field_name']; ?><?php echo $item['type']=='selects'?'[]':''; ?>"
        ...
        <?php break; case "video": ?>
            <div class="input-group">
                <input id="c-<?php echo $item['item_id']; ?>" class="form-control" name="<?php echo $item['field_name']; ?>" type="text" value="<?php echo htmlentities($item['value'] ?? ''); ?>" data-rule="<?php echo $item['rule']; ?>" data-tip="<?php echo $item['tip']; ?>">
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="plupload-<?php echo $item['field']; ?>" class="btn btn-danger plupload" data-input-id="c-<?php echo $item['item_id']; ?>" data-preview-id="p-<?php echo $item['field']; ?>" data-mimetype="video/*"  ><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                    <span><button type="button" id="fachoose-<?php echo $item['field']; ?>" class="btn btn-primary fachoose" data-input-id="c-<?php echo $item['item_id']; ?>" data-preview-id="p-<?php echo $item['field']; ?>" data-mimetype="video/*" ><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                </div>
                <span class="msg-box n-right" for="c-<?php echo $item['item_id']; ?>"></span>
            </div>
        ...
        <div class="input-group">
            <input id="c-<?php echo $item['item_id']; ?>" class="form-control" name="row[<?php echo htmlentities($item['field'] ?? ''); ?>]" type="text" value="<?php echo $item['value']; ?>" data-rule="<?php echo $item['rule']; ?>" data-tip="<?php echo $item['tip']; ?>">
            <div class="input-group-addon no-border no-padding">
                <span><button type="button" id="plupload-<?php echo $item['field']; ?>" class="btn btn-danger plupload" data-input-id="c-<?php echo $item['item_id']; ?>" data-multiple="<?php echo $item['type']=='file'?'false':'true'; ?>" <?php if($item['maximum']): ?>data-maxcount="<?php echo $item['maximum']; ?>" <?php endif; ?>><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                <span><button type="button" id="fachoose-<?php echo $item['field']; ?>" class="btn btn-primary fachoose" data-input-id="c-<?php echo $item['item_id']; ?>" data-multiple="<?php echo $item['type']=='file'?'false':'true'; ?>" <?php if($item['maximum']): ?>data-maxcount="<?php echo $item['maximum']; ?>" <?php endif; ?>><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
            </div>
            <span class="msg-box n-right" for="c-<?php echo $item['item_id']; ?>"></span>
        </div>
        <?php break; case "switch": ?>
        <input id="c-<?php echo $item['item_id']; ?>" name="<?php echo $item['field_name']; ?>" type="hidden" value="<?php echo $item['value']?1:0; ?>">
        <a href="javascript:;" data-toggle="switcher" class="btn-switcher" data-input-id="c-<?php echo $item['item_id']; ?>" data-yes="1" data-no="0">
            <i class="fa fa-toggle-on text-success <?php if(!$item['value']): ?>fa-flip-horizontal text-gray<?php endif; ?> fa-2x"></i>
        </a>
        <?php break; case "bool": ?>
        <label for="<?php echo $item['field_name']; ?>-yes"><input id="<?php echo $item['field_name']; ?>-yes" name="<?php echo $item['field_name']; ?>" type="radio" value="1" <?php echo !empty($item['value'])?'checked':''; ?> data-tip="<?php echo $item['tip']; ?>" /> <?php echo __('Yes'); ?></label>
        <label for="<?php echo $item['field_name']; ?>-no"><input id="<?php echo $item['field_name']; ?>-no" name="<?php echo $item['field_name']; ?>" type="radio" value="0" <?php echo !empty($item['value'])?'':'checked'; ?> data-tip="<?php echo $item['tip']; ?>" /> <?php echo __('No'); ?></label>
        <?php break; case "city": ?>
        <div style="position:relative">
        <input <?php echo $item['extend_html']; ?> type="text" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>" value="<?php echo htmlentities($item['value'] ?? ''); ?>" class="form-control" data-toggle="city-picker" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>" />
        </div>
        <?php break; case "tags": ?>
        <input id="c-<?php echo $item['item_id']; ?>" data-rule="" class="form-control" placeholder="输入后空格确认"name="<?php echo $item['field_name']; ?>"  type="text" value="<?php echo htmlentities($item['value'] ?? ''); ?>">
        ...
        <input <?php echo $item['extend_html']; ?> type="text" name="<?php echo $item['field_name']; ?>" id="c-<?php echo $item['item_id']; ?>"
