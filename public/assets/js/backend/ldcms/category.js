            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'urlname', title: __('Urlname'),width: 180,align: "left",formatter:function (value,row,index){
                            if(row.type==1){
                                return '<a href="'+row.url+'" target="_blank">'+row.url+'</a>';
                            }
                            return '<a href="'+row.url+'" target="_blank">'+value+'</a>';
                        }},
                        {field: 'mid_text', title: __('Mid')+'/类型',width: 100,formatter:function (value,row,index){
                            if(row['type']==0){
                            ...
                            return '<a href="'+row.url+'" target="_blank" class="label label-default"><i class="fa fa-link"></i> 链接</a>';
                        }},
                        ...
                        {field: 'is_nav', width:80,  title: __('Is_nav'), searchList: {"1": __('Yes'), "0": __('No')}, formatter: Table.api.formatter.toggle},
                        {field: 'status', width:80,  title: __('Status'),searchList: {"1": __('Yes'), "0": __('No')}, formatter: Table.api.formatter.toggle },
                        ...
                        {field: 'create_time',width:140,  title: __('Create_time'), operate:'RANGE', addclass:'datetimerange', autocomplete:false, formatter: Table.api.formatter.datetime},
                        {field: 'operate', title: __('Operate'), table: table, events: $.extend(Table.api.events.operate,Controller.api.events.operate), formatter: Table.api.formatter.operate,
                            buttons:[
                                {
                                    name: 'addson',
