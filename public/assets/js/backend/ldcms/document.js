        ...
        index: function () {
            ...
            var columns = [
                ...
                { field: 'title', title: __('Title'), operate: 'LIKE', align: 'left', customField: 'flag',formatter:function (value, row, index) {
                    var html='<div class="archives-title"><a href="' + row.url + '" target="_blank"><span style="color:' + (row.style_color ? row.style_color : 'inherit') + ';font-weight:' + (row.style_bold ? 'bold' : 'normal') + '">' + value + '</span></a></div>';
